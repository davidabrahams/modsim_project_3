function res = backward_acceleration(P, V, m_projectile, m_planet, r_planet, surface_density, atmosphere_height)
    % Outputs:
    %     res: [d2x/dt; d2y/dt]
    ...
    res = (F_grav_vector - F_drag_vector) / m_projectile; %Returns vector of acceleration 
end